...
function CALC() {
    // Get input values
    const Lift = (document.getElementById('LIFT') as HTMLInputElement).valueAsNumber;
    const Repetitions = (document.getElementById('REPETITIONS') as HTMLInputElement).valueAsNumber;
